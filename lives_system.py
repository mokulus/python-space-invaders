...
class LivesSystem(system.System):
    ...
    def __init__(self, game):
        self._game = game
        self._number_object = VariableTextObject(self._game, Point(8, 0), lambda g: str(g.player.lives()))
    ...
    def _remake_player_sprites(self):
        ...
        for i in range(self._game.player.lives() - 1):
            ...
            self._player_objects.append(StaticSprite(Point(3 * 8 + sprite.shape[0] * i, 0), sprite))
